...
tf.app.flags.DEFINE_string("data_file", "data/TrainVectors.pickle", "Data source.")
...
tf.app.flags.DEFINE_integer("checkpoint_every", 5000, "Save model after this many steps")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        starter_learning_rate = FLAGS.initial_learning_rate #1e-3

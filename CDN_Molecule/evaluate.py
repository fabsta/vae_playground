...
tf.app.flags.DEFINE_string("data_file", "data/drugVectorsGo.pickle", "Data source.")
tf.app.flags.DEFINE_string("parameters_file", "runs/1535170668/checkpoints/model-50",
                           "Checkpoint directory from training run")
tf.app.flags.DEFINE_string("output_file", "output/generated.smi", "Output file as SMILES")
...
tf.app.flags.DEFINE_float("unit_gaussian_dim", 300, "number of gaussians")
...
# Shuffle data
np.random.seed(10)
print("Num of input molecules: ", str(len(x)))
